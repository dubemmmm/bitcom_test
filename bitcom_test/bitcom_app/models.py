...
class Lga(models.Model):
    ...
    entered_by_user = models.CharField(max_length=50)
    date_entered = models.CharField(max_length=400)
    user_ip_address = models.CharField(max_length=50)
...
class NewPollingUnitResults(models.Model):
    result_id = models.AutoField(primary_key=True)
    polling_unit_name = models.CharField(max_length=300)
    pdp_votes = models.PositiveIntegerField()
    acn_votes = models.PositiveIntegerField()
    dpp_votes = models.PositiveIntegerField()
    ppa_votes = models.PositiveIntegerField()
    cdc_votes = models.PositiveIntegerField()
    anpp_votes = models.PositiveIntegerField()
    jp_votes = models.PositiveIntegerField()
    labour_votes = models.PositiveIntegerField()
    cpp_votes = models.PositiveIntegerField()
    entered_by_user = models.CharField(max_length=50)
